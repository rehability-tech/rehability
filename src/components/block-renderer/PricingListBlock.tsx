    ...
    <div className="max-w-3xl mx-auto px-4 w-full">
      <div className="flex flex-col gap-2 w-full">
        {content.items.map((item: any, idx: number) => (
          <div
            key={item.id || idx}
            className="relative flex flex-col @xl:flex-row @xl:items-center justify-between p-5 @xl:p-6 border-2 border-[#EBF4F5] rounded-[24px] hover:border-[#287D88] transition-colors duration-300 w-full bg-white group/price overflow-hidden"
          >
            ...
            <div className="relative z-10 flex flex-col gap-1.5 w-full @xl:w-2/3 pr-2 @xl:pr-8">
            ...
            <div className="relative z-10 mt-3 @xl:mt-0 flex items-center justify-start @xl:justify-end w-full @xl:w-1/3">
