    ...
    switch (type) {
      ...
      case "bookingOptions":
        defaultContent = {
          ...
          standardText:
            "<p>Kupujesz jedno miejsce. Jeśli w obiekcie są pokoje współdzielone, przydzielimy Cię do innego uczestnika wydarzenia.</p>",
          duoTitle: "Pakiet Wydarzenie we Dwoje (2 osoby)",
          duoText:
