...
function BlockEditorCardBase({
  ...
  return (
    ...
    >
      ...
      {!block.isGenerating && (
        <div className="absolute right-2 top-2 -translate-y-0 lg:top-1/2 lg:-translate-y-1/2 opacity-0 group-hover/element:opacity-100 group-focus-within/element:opacity-100 flex flex-row items-center gap-1 transition-opacity bg-white/95 backdrop-blur-md p-1 rounded-lg shadow-sm border border-gray-200 z-30">
          <button
            onClick={onMoveUp}
