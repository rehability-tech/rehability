...
const BASE_STEPS = [
  {
    ...
    path: "/admin/wydarzenia/dodaj/dane-podstawowe",
  ...
  },
  {
    id: 2,
    name: "Edytor treści",
    path: "/admin/wydarzenia/dodaj/edytor-tresci",
  ...
  },
  {
    id: 3,
    name: "E-mail",
    path: "/admin/wydarzenia/dodaj/zaproszenia",
    pathKey: "zaproszenia",
    icon: Envelope,
    requiresId: true,
  ...
  },
  {
    id: 4,
    name: "SEO",
    path: "/admin/wydarzenia/dodaj/seo",
    pathKey: "seo",
  ...
  },
  {
    id: 5,
    name: "Podsumowanie",
    path: "/admin/wydarzenia/dodaj/podsumowanie",
...
function StepperContent() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/admin/wydarzenia/${tripId}`)
      .then((r) => r.json())
      .then((data) => {
    ...
    // Odświeżamy przy KAŻDEJ zmianie kroku, nie tylko przy zmianie wydarzenia.
    // Stepper siedzi w layoucie i nie odmontowuje się przy przechodzeniu między
    // krokami — bez tego po wyłączeniu opcji "zabierz osobę towarzyszącą"
    // krok "E-mail" wisiał na ekranie aż do pełnego przeładowania strony.
  }, [tripId, pathname]);
