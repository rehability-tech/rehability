...
export interface AiGeneratedData {
  ...
  startDate?: string;
  endDate?: string;
  // Ostatni dzień zapisów (włącznie). null / brak = zapisy do dnia rozpoczęcia.
              ...
              {!isLocalGenerating ? (
                ...
                >
                  ...
                  <p className="text-sm text-gray-500 font-montserrat mb-4">
                    {description ??
                      "Opisz swoje wydarzenie. AI przygotuje dla Ciebie chwytliwy tytuł i dopasuje podstawowe informacje, takie jak lokalizacja czy ilość miejsc."}
                  </p>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      placeholder={
                        placeholder ??
                        "np. Weekendowe wydarzenie w górach dla 10 osób z jogą, winem i masażami w Jarnołtówku..."
                      }
                ...
                >
                  ...
                  >
                    Architekt AI analizuje wydarzenie i układa optymalny układ.
                  </motion.p>
                </motion.div>
              )}
            </AnimatePresence>
