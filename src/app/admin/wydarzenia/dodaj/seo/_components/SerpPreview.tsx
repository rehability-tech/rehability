...
export default function SerpPreview({
  ...
  const displayTitle = metaTitle || "Tytuł wydarzenia pojawi się tutaj...";
  const displayDesc =
    metaDescription ||
    "Opis meta wydarzenia pojawi się tutaj. Opisz krótko gdzie, kiedy i dla kogo jest ten trip.";
  const displayUrl = `rehability.pl › wydarzenia › ${tripId || "twoje-wydarzenie"}`;
