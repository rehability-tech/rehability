      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2 mb-5 rounded-2xl bg-slate-100 p-1">
            ...
            >
              <House size={16} weight="bold" /> Tylko to wydarzenie
            </button>
            <button
              type="button"
              ...
              title={
                canGlobal
                  ? "Zmieni usługę w katalogu i wszystkich powiązanych wydarzeniach"
                ...
                <div className="mb-4 flex gap-2 rounded-2xl bg-amber-50 border border-amber-200 p-3 text-[12px] text-amber-700">
                  ...
                  <span>
                    ...
                    <strong>
                      ...
                      {service.linkedCampsCount === 1 ? "wydarzeniu" : "wydarzeniach"}
                    </strong>
