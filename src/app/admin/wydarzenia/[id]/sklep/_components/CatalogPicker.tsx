...
export function CatalogPicker({
  ...
  // Dodaje wskazane usługi katalogowe do wydarzenia; zwraca po zakończeniu
    ...
    <div className="rounded-3xl rounded-tr-none border border-white/60 bg-white/70 backdrop-blur-2xl p-5 shadow-[0_2px_12px_-4px_rgba(0,0,0,0.05)]">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[12px] text-slate-400 font-medium">
              Dodaj usługi z bazy do tego wydarzenia
            </p>
          </div>
        </div>
        <button
          ...
          >
            <div className="mb-4 grid grid-cols-1 sm:grid-cols-2 gap-3 rounded-2xl bg-slate-50/80 p-4">
              ...
              >
                ...
                Zapisz w katalogu i dodaj do wydarzenia
              </button>
            </div>
          </motion.div>
        )}
      ...
      {selected.size > 0 && (
        ...
        >
          ...
          Dodaj zaznaczone ({selected.size}) do wydarzenia
        </button>
      )}
    </div>
  );
