...
// Buduje listę wszystkich transakcji uczestnika w obrębie tego wydarzenia:
// wpłata za wydarzenie (zadatek/dopłata) + każda zarezerwowana usługa SPA.
function buildTransactions(participant: ParticipantData): Transaction[] {
  ...
  // Transakcja za samo wydarzenie (kwoty trzymamy łącznie w Booking.amountPaid).
