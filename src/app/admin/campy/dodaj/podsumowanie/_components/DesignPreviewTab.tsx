...
import PreviewUpcomingCamp from "./PreviewUpcomingCamp";
          ...
          >
            ...
            {designTab === "strona_glowna" && (
              <div className="w-full flex flex-col">
                <PreviewUpcomingCamp camp={camp} viewMode={viewMode} />
              </div>
            )}

            {designTab === "karta" && (
              <CardPreviewTab camp={camp} viewMode={viewMode} />
            )}

            {designTab === "opis" && (
              <DescriptionPreviewTab camp={camp} viewMode={viewMode} />
            )}
          </motion.div>
        </AnimatePresence>
      </div>
