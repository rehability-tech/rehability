...
import { createEvent, updateEvent, type EventInput } from "@/app/actions/trip-events";
  ...
  const submit = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      const res = isEdit && initial.id
        ...
        : await createEvent(tripId, payload);
      ...
      >
        ...
        <form onSubmit={submit} className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
          ...
          <div>
            ...
            <select
              value={type}
              onChange={(e) => setType(e.target.value as TripEventType)}
