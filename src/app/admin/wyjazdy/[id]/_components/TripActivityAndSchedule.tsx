...
// =========================================
// OSTATNIE LOGI WYJAZDU (aktywności)
// =========================================
    ...
    const fetchActivities = async () => {
      ...
      try {
        ...
        const res = await fetch(
          `/api/admin/wyjazdy/${tripId}/activity?${qs.toString()}&t=${Date.now()}`,
          { cache: "no-store" },
        );
        if (res.ok) {
...
// Pokazuje wydarzenia wyjazdu ORAZ rezerwacje usług uczestniczek.
// =========================================
      ...
      <div className="relative flex items-center gap-3 mb-5 border-b border-gray-100 pb-4 shrink-0">
        ...
        <div>
          ...
          <p className="text-[12px] text-brand-secondary/60">
            Plan wyjazdu i rezerwacje uczestniczek
          </p>
        </div>
      </div>
