...
export default function AdminCampyList() {
  ...
  // Wspólny nagłówek sekcji (akcent w stylu panelu pojedynczego wyjazdu)
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            <div className="max-w-xl">
              ...
              <p className="font-montserrat text-white/70 font-medium text-[14px] mt-3 leading-relaxed">
                Przeglądaj wszystkie wyjazdy w jednym miejscu. Wybierz konkretny
