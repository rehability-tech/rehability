...
import { BlockType } from "../hooks/useTripAiGenerator";
...
export default function BlockAdder({ onAddBlock }: BlockAdderProps) {
  ...
  const blockOptions: {
  ...
  }[] = [
    {
      type: "heading",
      label: "Nagłówek",
      desc: "Duży tytuł sekcji",
      icon: <TextH size={20} />,
    },
    {
      type: "paragraph",
      label: "Akapit tekstu",
      desc: "Zwykły blok tekstowy",
      icon: <TextAa size={20} />,
    },
    {
      type: "highlight",
      label: "Wyróżnik",
      desc: "Tekst w ramce z lupą",
      icon: <Star size={20} />,
    },
    {
      type: "bulletList",
      label: "Lista punktowana",
      desc: "Lista z ikonką ptaszka",
      icon: <ListBulletsIcon size={20} />,
    },
    {
      type: "featuresGrid",
      label: "Karty zalet",
      desc: "Siatka z ikonkami",
      icon: <Cards size={20} />,
    },
    {
      type: "pricingList",
      label: "Lista usług",
      desc: "Cennik (np. Warsztaty)",
      icon: <Money size={20} />,
    },
    {
      type: "faq",
        ...
        <div className="w-full bg-gray-50 border border-gray-200 rounded-[16px] p-4 animate-in fade-in zoom-in-95 duration-200 shadow-sm">
          <div className="flex items-center justify-between mb-4 pb-2 border-b border-gray-200">
            ...
            <div className="flex items-center gap-1">
              <Tooltip
                content="Dodawaj elementy jeden pod drugim. Użyj elementu 'Przerwa', aby oddzielić tematy."
                position="top"
              >
