...
interface HubVodWidgetProps {
  ...
  continueCourse?: { title: string; slug: string } | null;
}
      ...
      <div className="relative overflow-hidden rounded-3xl rounded-tr-none bg-white/60 backdrop-blur-2xl border border-white/40 shadow-[0_20px_60px_-30px_rgba(3,63,99,0.25)] p-6 lg:p-8 h-full min-h-[340px] flex flex-col">
        ...
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="relative w-20 h-20 rounded-2xl rounded-tr-none bg-white border border-white/80 shadow-[0_15px_35px_-10px_rgba(3,63,99,0.15)] flex items-center justify-center shrink-0">
            <MonitorPlay size={40} weight="duotone" className="text-brand-primary/60" />
            <span className="absolute -top-2.5 -right-2.5 w-7 h-7 rounded-full bg-brand-secondary flex items-center justify-center shadow-[0_4px_15px_0px_rgba(0,0,0,0.2)]">
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl rounded-tr-none bg-white/60 backdrop-blur-2xl border border-white/40 shadow-[0_20px_60px_-30px_rgba(3,63,99,0.25)] p-6 lg:p-8 h-full min-h-[340px] flex flex-col">
      ...
      <div className="flex-1">
        ...
        {continueCourse ? (
          <Link
            ...
            className="group block bg-white/50 border border-gray-100 rounded-2xl p-4 max-w-sm hover:bg-white/80 hover:border-brand-primary/20 transition-all"
          >
            ...
            <p className="font-montserrat font-semibold text-[13px] text-brand-secondary truncate group-hover:text-brand-primary transition-colors">
      ...
      <div className="mt-8 grid grid-cols-2 gap-3">
        ...
        <Link
          href="/panel/vod"
          className="group relative inline-flex items-center justify-center gap-2 px-3 py-3 rounded-2xl rounded-tr-[3px] bg-brand-primary text-white font-bold text-[13px] border border-brand-yellow/30 shadow-[0_6px_18px_-4px_rgba(40,125,136,0.5)] hover:shadow-[0_8px_22px_0px_rgba(242,217,103,0.45)] transition-all overflow-hidden"
        >
          <span className="pointer-events-none absolute -right-2 -bottom-2 size-9 rounded-full bg-brand-yellow/50 blur-[12px]" />
        ...
        <Link
          href="/kursy"
          className="group inline-flex items-center justify-center gap-1.5 px-3 py-3 rounded-2xl rounded-tr-[3px] bg-white/70 border border-brand-primary/20 text-brand-secondary font-bold text-[13px] hover:border-brand-primary/50 hover:bg-white transition-all"
        >
          <ShoppingBag size={16} weight="duotone" className="text-brand-primary" />
          Przeglądaj kursy
        </Link>
      </div>
    </div>
