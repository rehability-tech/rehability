  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-20 px-4 bg-white rounded-3xl border border-gray-100 shadow-sm mt-8">
      ...
      <h3 className="font-jakarta font-bold text-2xl text-brand-secondary mb-3">
        Brak aktywnych wyjazdów
      </h3>
      <p className="text-gray-500 max-w-md mx-auto mb-8">
        Nie masz jeszcze zarezerwowanego żadnego wyjazdu. Odkryj nasze
        nadchodzące wyjazdy i dołącz do społeczności Rehability!
      </p>
      <Link
        href="/wyjazdy"
      ...
      >
        Przeglądaj wyjazdy <ArrowRight size={16} weight="bold" />
      </Link>
    </div>
  );
}
