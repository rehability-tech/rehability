...
export default function ActiveTripDashboard({ booking }: { booking: any }) {
  ...
  // Formatowanie daty wyjazdu
  const startDate = new Date(trip.startDate).toLocaleDateString("pl-PL", {
    day: "2-digit",
    month: "2-digit",
    year: "numeric",
  });
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6 w-full">
        {/* LEWA STRONA: Dane informacyjne o wyjeździe */}
        ...
        <div className="shrink-0 w-full md:w-auto">
          <Link href={`/panel/wyjazdy/${booking.id}`} className="block w-full">
