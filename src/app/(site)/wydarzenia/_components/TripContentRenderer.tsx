...
export default function TripContentRenderer({ blocks, className }: Props) {
    ...
    return (
      ...
      >
        ...
        <p className="text-[13px] text-brand-secondary/60 mt-1.5 max-w-md mx-auto">
          Pracujemy nad pełnym programem wydarzenia. Wróć tu wkrótce.
        </p>
      </div>
    );
  }
