...
export function StrefaDynamiczna({ activeTab }: StrefaProps) {
  ...
  return (
    <section className="relative w-full py-32 max-[1024px]:py-20 overflow-x-clip min-h-[800px]">
      {/* Tło zmienia się dynamicznie - crossfade */}
      ...
      <div className="container relative z-10 mx-auto px-4 max-[1024px]:px-6">
        {/* AnimatePresence odpowiada za płynne usunięcie i wstawienie nowej zawartości przy zmianie taba */}
        <AnimatePresence mode="wait">
          <motion.div
            key={activeTab} // Klucz mówi Framer Motion, że komponent się zmienił
          ...
          >
            {/* === NAGŁÓWEK I OPIS === */}
            <div className="max-w-[900px] mx-auto text-center mb-24 max-[1024px]:mb-16">
            ...
            <div className="hidden min-[1024px]:flex flex-row justify-center items-start max-w-[1200px] mx-auto">
              ...
              <div className="relative w-[385px] h-[347px] mr-[41px] mt-[28px] shrink-0">
                <motion.div
                  ...
                  className="absolute top-0 right-0 w-[220px] h-[235px] rounded-[29px] overflow-hidden shadow-md"
                >
                  <Image
                ...
                <motion.div
                  variants={itemVariants}
                  className="absolute bottom-0 left-0 w-[138px] h-[138px] rounded-[29px] overflow-hidden shadow-sm"
                >
                  <Image
              ...
              <motion.div
                variants={itemVariants}
                className="relative w-[360px] h-[363px] rounded-[29px] overflow-hidden shadow-xl z-10 shrink-0"
              >
                <Image
              ...
              <div className="relative w-[251px] h-[344px] ml-[31px] shrink-0">
                <motion.div
                  variants={itemVariants}
                  className="absolute top-0 left-0 w-[155px] h-[163px] rounded-[29px] overflow-hidden shadow-sm"
                >
                  <Image
                ...
                <motion.div
                  variants={itemVariants}
                  className="absolute bottom-0 right-0 w-[159px] h-[151px] rounded-[29px] overflow-hidden shadow-md"
                >
                  <Image
            ...
            <motion.div
              variants={itemVariants}
              className="min-[1024px]:hidden relative w-full max-w-[600px] mx-auto aspect-[4/3] rounded-[32px] overflow-hidden shadow-xl"
            >
