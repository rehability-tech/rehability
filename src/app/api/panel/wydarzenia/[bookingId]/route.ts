// src/app/api/panel/wydarzenia/[bookingId]/route.ts
...
export async function GET(
  ...
  try {
    // 1. Pobieramy główne dane o rezerwacji i wydarzeniu
    ...
    console.error("[API] Błąd pobierania danych wydarzenia:", error);
