...
import { campSeoSchema } from "@/lib/zod/campsValidators";
import { z } from "zod";

const paramsSchema = z.object({ id: z.string().min(1, "Brak ID Campa") });

// ==========================================
// PATCH: Aktualizacja danych SEO Campa
// ==========================================
export async function PATCH(
  ...
  try {
    ...
    const validatedBody = campSeoSchema.safeParse(body);
    ...
    console.error("Błąd PATCH SEO Campa:", error);
    return NextResponse.json(
