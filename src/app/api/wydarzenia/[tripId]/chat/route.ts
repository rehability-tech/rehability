// src/app/api/wydarzenia/[tripId]/chat/route.ts
...
const paramsSchema = z.object({
  tripId: z.string().cuid("Nieprawidłowy format ID wydarzenia"),
});
...
/**
 * Sprawdza, czy zalogowany użytkownik ma dostęp do czatu danego wydarzenia.
  ...
  try {
    if (isAdmin) {
        ...
        bookings
          ...
          .map((b) =>
            dispatchNotification({
              ...
              message: snippet,
              link: `/panel/wydarzenia/${b.id}/chat`,
              type: "INFO",
      ...
      await dispatchNotification({
        ...
        message: snippet,
        link: `/admin/wydarzenia/${tripId}/chat`,
        type: "INFO",
        channels: ["IN_APP", "PUSH"],
      });
    }
